...
public class SimpleRecyclerViewAdapter<L>
    ...
    @NonNull private final Map<Integer, SimpleViewType> viewTypes = new HashMap<>();
    @NonNull private final List<SimpleAdapterItem> adapterItems = new ArrayList<>();

    public SimpleRecyclerViewAdapter(@NonNull L listener) {
